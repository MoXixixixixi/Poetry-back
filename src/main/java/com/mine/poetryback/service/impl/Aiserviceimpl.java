...
public class Aiserviceimpl implements Aiservice {
    private static final String API_KEY = "b8e9e83d163a6eb9f7883e31754ee2d6";

    private static final String API_SECRET = "0ECBWb937jJbTRN8";
...
//        queryFineTuningJobRequest.setAfter("1");
     ...
     */
    @Override
    public String testImageToWord(String url) {
...
//        System.out.println("model output:" + JSON.toJSONString(modelApiResponse));
        return JSON.toJSONString(modelApiResponse);
    }
    @Override
    public String testCreateImage(String describe) {
        CreateImageRequest createImageRequest = new CreateImageRequest();
        createImageRequest.setModel(Constants.ModelCogView);
        createImageRequest.setPrompt(describe);
...
//        System.out.println("imageApiResponse:" + JSON.toJSONString(imageApiResponse));
        return JSON.toJSONString(imageApiResponse);
    }
     ...
     */
//    @Override
//    public String huida(String question) {
//        List<ChatMessage> messages = new ArrayList<>();
...
//        return "model output:" + JSON.toJSONString(sseModelApiResp);
//    }
//
